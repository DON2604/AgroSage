...
class _SocialAppWidgetState extends State<SocialAppWidget> {
  ...
  Future<void> _sendTicket() async {
    ...
    try {
      ...
      final url = Uri.parse('https://ed3c-103-51-148-129.ngrok-free.app/api/tickets');
...
Future<void> _fetchAgentFeedback(String query) async {
  try {
    final url = Uri.parse('https://ed3c-103-51-148-129.ngrok-free.app/feedback');
    final response = await http.post(
      url,
      headers: {
        'Content-Type': 'application/json',
  ...
  Future<void> _fetchResponses([String? ticketId]) async {
    ...
    final url = Uri.parse('https://ed3c-103-51-148-129.ngrok-free.app/api/responses');
    final response = await http.get(
      url,
      headers: {
        'Accept': 'application/json',
